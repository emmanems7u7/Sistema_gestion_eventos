            ...
            <table class="table align-items-center mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Disponible</th>
                ...
                <tbody>
                    ...
                    @foreach ($users as $usuario)
                        <tr>
                            ...
                            <td>
                            @switch($usuario->disponible)
                                @case(1)
                                    <span class="bg-success text-white px-2 py-1 rounded">Disponible</span>
                                    @break

                                @case(2)
                                    <span class="bg-warning text-dark px-2 py-1 rounded">En evento</span>
                                    @break

                                @case(3)
                                    <span class="bg-warning text-dark px-2 py-1 rounded">No disponible</span>
                                    @break

                                @default
                                    <span class="bg-secondary text-white px-2 py-1 rounded">Desconocido</span>
                            @endswitch
                            </td>
