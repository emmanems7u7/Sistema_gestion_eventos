    ...
    public function run(): void
    {
        DB::table('menus')->insert([
            ...
            [
                ...
                'padre_id' => null,
                'seccion_id' => 11,
                'ruta' => 'inventarios.index',
                'accion_usuario' => null,
                'created_at' => Carbon::parse('2025-05-08 06:07:28'),
                'updated_at' => Carbon::parse('2025-05-08 06:07:28'),
            ],
            [
                'id' => 14,
                'nombre' => 'Solicitudes de Eventos',
                'orden' => 1,
                'padre_id' => null,
                'seccion_id' => 12,
                'ruta' => 'solicitudes.index',
                'accion_usuario' => null,
                'created_at' => Carbon::parse('2025-05-08 07:19:12'),
                'updated_at' => Carbon::parse('2025-05-08 07:19:12'),
            ],
            [
                'id' => 16,
                'nombre' => 'Eventos Aprobados',
                'orden' => 3,
                'padre_id' => null,
                'seccion_id' => 12,
                'ruta' => 'eventos.index',
                'accion_usuario' => null,
                'created_at' => Carbon::parse('2025-05-08 07:59:03'),
                'updated_at' => Carbon::parse('2025-05-08 07:59:03'),
            ],
            [
                'id' => 17,
                ...
                'accion_usuario' => null,
                'created_at' => Carbon::parse('2025-05-10 03:14:38'),
                'updated_at' => Carbon::parse('2025-05-10 03:14:38'),
            ],
        ]);
    }
}
